...
namespace Scientific_Calculator
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtDisplay.Size = new Size(260, 20);  
        ...
        private void CreateCalculatorButtons()
        {
            ...
            for (int i = 0; i <= 9; i++)
            {
                var btn = new Button();
                btn.Text = i.ToString();
                btn.Location = new Point(12 + (i % 3) * 60, 50 + (i / 3) * 50);
            ...
            for (int i = 0; i < operations.Length; i++)
            {
                ...
                btn.Location = new Point(200, 50 + i * 50);
                btn.Size = new Size(50, 50);
            ...
            btnEquals.Text = "=";
            btnEquals.Location = new Point(12, 250);
            ...
            btnClear.Text = "C";
            btnClear.Location = new Point(120, 250);
